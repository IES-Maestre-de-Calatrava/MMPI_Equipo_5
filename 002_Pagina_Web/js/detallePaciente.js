...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    if (btnAdd) {
        btnAdd.addEventListener("click", function () {
            window.location.href = "anadir_paciente.html";
        });
    }
...
function configurarBotonesPaciente(dniPaciente, datosCompletos) {
    ...
    if (btnEditar) {
        btnEditar.href = "anadir_paciente.html?id=" + encodeURIComponent(dniPaciente) + "&modo=editar";
    }
    ...
    if (datosCompletos === 0) {
        ...
        if (btnCompletar) {
            ...
            btnCompletar.href = "anadir_paciente.html?id=" + encodeURIComponent(dniPaciente) + "&modo=completar";
        }
