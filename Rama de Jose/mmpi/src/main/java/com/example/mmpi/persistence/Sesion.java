...
public class Sesion implements java.io.Serializable {
    ...
    public Sesion(String idSesion, Integer aceleracionesBruscas, Integer colisiones, Integer estabilidad, Integer nivel, Integer paradasBruscas, Integer score, Integer tiempoMovimiento,
LocalDateTime tiempoSesion, Fisioterapeuta fisioterapeuta, Paciente paciente, Dispositivo dispositivo) {
