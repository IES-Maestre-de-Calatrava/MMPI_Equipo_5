...
public class SesionDTO {
    ...
    public SesionDTO(String idSesion, Integer aceleracionesBruscas, Integer colisiones, Integer estabilidad, Integer nivel, Integer paradasBruscas, Integer score, Integer tiempoMovimiento,
